        ...
        <div className="items-center px-1 space-y-3 mt-20">
          ...
          <div className="px-0 flex space-x-5 justify-center">
            ...
            <div>
              {/* Small Device Image */}
              <Image
                src="/images/w-img-fb.png" // Small image
                alt="Facebook"
                width={24}
                height={24}
              ...
              {/* Large Device Image */}
              <Image
                src="/images/w-img-fb.png" // Large image
                alt="Facebook"
                width={24}
                height={24}
            ...
            <div>
              <Image
                src="/images/w-img-inst.png" // Small image
                alt="Instagram"
                width={24}
                height={24}
              ...
              />
              <Image
                src="/images/w-img-inst.png" // Large image
                alt="Instagram"
                width={24}
                height={24}
            ...
            <div>
              <Image
                src="/images/w-img-twt.png" // Small image
                alt="Twitter"
                width={24}
                height={24}
                className="w-[20px] h-[20px] md:hidden"
              />
              <Image
                src="/images/w-img-twt.png" // Large image
                alt="Twitter"
                width={24}
                height={24}
                className="w-[24px] h-[24px] hidden md:block"
